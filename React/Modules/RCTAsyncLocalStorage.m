...
static NSString *RCTGetStorageDirectory(void)
{
...
static NSString *RCTGetManifestFilePath(void)
{
...
static dispatch_queue_t RCTGetMethodQueue(void)
{
...
static NSCache *RCTGetCache(void)
{
...
static NSDictionary *RCTDeleteStorageDirectory(void)
{
  NSError *error;
